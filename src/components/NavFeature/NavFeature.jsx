...
const NavFeature = ({ feature, changeFeature, logout, togglePopUp, user, reqFriends, isMobile }) => {

    const menuUser = useRef();
    const btnToggle = useRef();
    const userMenu = useRef();
    const listFeature = useRef();
    let toggleMenuUser = () => {
    ...
    return (
        <div className="navFeature">
            {isMobile && <button id="change-nav" onClick={(e) => changeNav(e)} ref={btnToggle}><i className="fas fa-angle-up"></i></button>}
            ...
            <ul className="list-feature" ref={listFeature}>
                <li>
